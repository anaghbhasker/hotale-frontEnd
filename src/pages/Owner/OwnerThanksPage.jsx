    ...
    return (
      ...
      <div>
        <div className="flex flex-col items-center space-y-2">
          ...
          <p>Thank you for your interest! Your Request will be verified by the admin and you will receive message regarding that...</p>
...
export default OwnerThanksPage