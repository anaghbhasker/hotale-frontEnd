    ...
    <>
      <div className="bg-black py-36 overflow-hidden">
        <div className="px-4 py-12">
          <div className="rounded relative bg-black py-12">
            <div className="rounded-full bg-black w-[177px] h-[177px] relative flex justify-center items-center mx-auto animate-spin">
              <svg
              ...
              <div className="div rounded-full bg-black w-[150px] h-[150px]" />
            </div>
            <p className="mt-6 text-white text-base font-medium text-center">
              Loading ...
            </p>
          </div>
        </div>
